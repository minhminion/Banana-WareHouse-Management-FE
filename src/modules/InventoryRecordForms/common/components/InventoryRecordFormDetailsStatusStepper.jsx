...
const InventoryRecordFormDetailsStatusStepper = ({ status }) => {
  ...
  const isStepCancel = (step) => {
    return step === 3 && status === INVENTORY_RECORD_STATUS.CANCELED;
  };
...
export default InventoryRecordFormDetailsStatusStepper;
