...
const handler = {
  ...
  [actions.fetchGoodsDeliveryNotesPending]: (state, action) => ({
    ...state,
    isLoading: true,
  }),
  [actions.fetchGoodsDeliveryNotesSuccess]: (state, action) => ({
    ...state,
    isLoading: false,
    data: action.payload,
  }),
  [actions.fetchGoodsDeliveryNotesFailure]: (state, action) => ({
    ...state,
    isLoading: false,
