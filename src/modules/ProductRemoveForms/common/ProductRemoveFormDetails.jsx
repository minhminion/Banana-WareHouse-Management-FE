...
import ProductRemoveFormDetailsStatus from "./components/ProductRemoveFormDetailsStatus";
import { MODULE_NAME } from "../constants/models";
import ListProductRemoveFormProducts from "./components/ListProductRemoveFormProducts";
import ProductRemoveFormDetailsStatusStepper from "./components/ProductRemoveFormDetailsStatusStepper";
...
const ProductRemoveFormDetails = ({
  productRemoveDetails,
  initialValues,
  isEdit = true,
  onSubmit,
  ...
  return (
    <Box className={classes.root}>
      {values.status === ENUMS.PRODUCT_REMOVE_STATUS.CANCELED && (
        <Box clone mb={2}>
       ...
       {values.id && <ProductRemoveFormDetailsStatusStepper status={values.status} />}

      <Grid container spacing={3}>
        <Grid item className={clsx(classes.root, classes.leftSide)}>
          {/*Status */}
          <ProductRemoveFormDetailsStatus
            value={values.status}
        ...
        <Grid item className={clsx(classes.root, classes.rightSide)}>
          <Box className={classes.productDescription}>
            <ListProductRemoveFormProducts
              listProduct={productRemoveDetails}
              isEdit={isEdit && values.status === PRODUCT_REMOVE_STATUS.NEW}
              data={values.productRemoveDetails}
              errors={errors}
...
export default ProductRemoveFormDetails;
