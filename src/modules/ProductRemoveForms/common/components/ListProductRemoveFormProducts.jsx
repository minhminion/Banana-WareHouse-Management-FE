...
const ListProductRemoveFormProducts = ({
  data,
  onChange,
  isEdit = false,
}) => {
            ...
            <TableRow>
              ...
              <TableCell align="left">
                <Box display="flex">
                  <InputBase
                    disabled={!isEdit}
                    name={`removedQuantity_product_${product.id}`}
                    error={row.removedQuantity?.length === 0}
                    value={row.removedQuantity}
                    style={{
...
export default ListProductRemoveFormProducts;
