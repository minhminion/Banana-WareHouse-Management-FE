...
const ProductRemoveFormDetailsStatusStepper = ({ status }) => {
  ...
  const isStepCancel = (step) => {
    return step === 3 && status === PRODUCT_REMOVE_STATUS.CANCELED;
  };
...
export default ProductRemoveFormDetailsStatusStepper;
