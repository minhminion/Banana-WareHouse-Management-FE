...
import ListGoodsReceivingOfReturnsItem from "./common/ListGoodsReceivingOfReturnsItem";
import handler from "./constants/handler";
...
const ListGoodsReceivingOfReturns = (props) => {
  ...
  const [
    ...
    setSelectCancelGoodsReceivingOfReturns,
  ] = useState({});
  ...
  const {
    fetchGoodsReceivingOfReturns,
    deleteGoodsReceivingOfReturn,
  ...
  const handleCloseCancelGoodsReceivingOfReturns = () => {
    setSelectCancelGoodsReceivingOfReturns({});
  };

  const handleCancelGoodsReceivingOfReturns = async () => {
    if (
      selectCancelGoodsReceivingOfReturns &&
      selectCancelGoodsReceivingOfReturns.id
    ) {
      const result = await deleteGoodsReceivingOfReturn(
        selectCancelGoodsReceivingOfReturns.id
      );
      if (result === true) {
        handleCloseCancelGoodsReceivingOfReturns();
        fetchGoodsReceivingOfReturns({
          ...filter,
          limit: LIMIT_PER_PAGE,
        });
    ...
    <div>
        ...
        <div style={{ display: "flex" }}>
          ...
          <Box mr={1} clone>
            ...
            >
              ...
              <MenuItem value={GOOD_RECEIVING_RETURN_STATUS.NEW}>Mới</MenuItem>
              <MenuItem value={GOOD_RECEIVING_RETURN_STATUS.PENDING}>
                Chờ xác nhận
              </MenuItem>
              <MenuItem value={GOOD_RECEIVING_RETURN_STATUS.APPROVED}>
                Xác nhận
              </MenuItem>
              <MenuItem value={GOOD_RECEIVING_RETURN_STATUS.DONE}>
                Hoàn tất
              </MenuItem>
              <MenuItem value={GOOD_RECEIVING_RETURN_STATUS.CANCELED}>
                Hủy
              </MenuItem>
            </Select>
          </Box>
      ...
      <TableContainer component={Box}>
        <Table className={classes.tableRoot} aria-label="simple table">
          ...
          {data &&
            data.map((row) => (
              <ListGoodsReceivingOfReturnsItem
                key={row.id}
                row={row}
                onCancel={setSelectCancelGoodsReceivingOfReturns}
              />
            ))}
          {/* </TableBody> */}
        </Table>
      ...
      >
        ...
        <DialogActions>
          <Button onClick={handleCloseCancelGoodsReceivingOfReturns}>
            Hủy
          </Button>
          <Button onClick={handleCancelGoodsReceivingOfReturns} color="primary">
            Xác nhận
          </Button>
        </DialogActions>
      </Dialog>
...
export default ListGoodsReceivingOfReturns;
