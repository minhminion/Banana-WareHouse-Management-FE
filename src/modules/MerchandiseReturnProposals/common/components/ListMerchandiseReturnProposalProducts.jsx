...
const ListMerchandiseReturnProposalProducts = ({
  listProduct,
  data,
  onChange,
  isEdit = false,
                  ...
                  <IconButton
                    onClick={(e) =>
                      handleOpenContext(e, {
                        ...
                        quantityNeed: row.quantity - row.quantityReturned,
    ...
    <Fragment>
      ...
      >
        {contextPos.quantityDetails && (
          <List dense>
            <ListItem>
              <strong style={{ marginRight: 8 }}>Số lượng đã xuất kho:</strong>
              {contextPos.quantityDetails?.quantityExported}
            </ListItem>
            <ListItem>
              <strong style={{ marginRight: 8 }}>Số lượng cần:</strong>
              {contextPos.quantityDetails?.quantityNeed || 0}
            </ListItem>
            <ListItem>
              <strong style={{ marginRight: 8 }}>Số lượng đã trả:</strong>
...
export default ListMerchandiseReturnProposalProducts;
